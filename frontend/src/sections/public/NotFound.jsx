...
export default function NotFound() {
  return (
    <div className="container-page flex min-h-[60vh] flex-col items-center justify-center py-16 text-center">
      ...
      <p className="mt-6 font-display text-6xl font-extrabold tracking-tight text-ink-900">404</p>
      <h1 className="mt-2 text-2xl font-extrabold text-ink-900">This page has moved on</h1>
