          ...
          <form onSubmit={subscribe} className="flex w-full flex-col gap-3 sm:flex-row">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-12 w-full rounded-full border border-white/15 bg-white/5 pl-11 pr-4 text-sm text-white placeholder:text-ink-500 focus:border-brand-400 focus:outline-none focus:ring-4 focus:ring-brand-500/20"
              />
            </div>
          ...
          <div className="mt-6 flex gap-2">
            {SOCIALS.map((social) => (
              <a
                ...
                className="grid size-10 place-items-center rounded-xl border border-white/10 bg-white/5 text-ink-300 transition hover:-translate-y-0.5 hover:border-brand-400/50 hover:bg-brand-500/15 hover:text-white"
              >
